window.convert = function(multiplier, originalMultiplier) {
	...
	$('.ingredient').each(function() {
		...
		if (obj.unitValue !== null) {
			obj.unitValue = (obj.unitValue * multiplier).toFixed(2);
		...
		var convertedUnitValue = obj.unitValue ? obj.unitValue : '';
		var convertedUnitType = obj.unitType ? obj.unitType : '';
