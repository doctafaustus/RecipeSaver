...
passport.use(new TwitterStrategy({
    ...
    callbackURL: process.env.PORT ? 'http://www.recipesaver.net/login/twitter/return' : 'http://127.0.0.1:3000/login/twitter/return',
...
passport.use(new FacebookStrategy({
    ...
    callbackURL: process.env.PORT ? 'https://www.recipesaver.net/login/facebook/callback' : 'http://127.0.0.1:3000/login/facebook/callback',
    passReqToCallback: true
  },
...
passport.use(new GoogleStrategy({
    ...
    callbackURL: process.env.PORT ? 'http://recipesaver.net/login/google/callback' : 'http://127.0.0.1:3000/login/google/callback',
    passReqToCallback: true
  },
	function(req, token, refreshToken, profile, done) {
		process.nextTick(function() {
